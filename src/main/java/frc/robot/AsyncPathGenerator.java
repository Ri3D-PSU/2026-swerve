...
public class AsyncPathGenerator {
    public static Future<PathPlannerPath> generatePathAsync(Pose2d finalPosition, Rotation2d goalRotation, Drive drive) {
        ...
        return CompletableFuture.supplyAsync(() -> {
            PathConstraints constraints = new PathConstraints(Constants.MAX_LINEAR_SPEED_AUTO, 2.0, Constants.MAX_ANGULAR_SPEED, 4 * Math.PI); // The constraints for this path.
